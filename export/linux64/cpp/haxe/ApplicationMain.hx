...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Example, Inc.", "MyApplication", "com.example.myapp", "1.0.0");
		...
		telemetryConfig.app_name = "MyApplication";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MyApplication", null, { width: 640, height: 480 });
