...
::openfl::_legacy::filters::ColorMatrixFilter_obj::__register();
...
::flixel::_system::debug::console::_ConsoleUtil::Interp_obj::__register();
...
::StateOption_obj::__register();
::StateMenu_obj::__register();
::StateGameOver_obj::__register();
::flixel::FlxState_obj::__register();
::Reflect_obj::__register();
::ObjectPlayer_obj::__register();
::ObjectHUDCombat_obj::__register();
::ObjectHUD_obj::__register();
::flixel::group::FlxTypedGroup_obj::__register();
::ObjectFiniteStateMachine_obj::__register();
::ObjectEnemy_obj::__register();
::ObjectCoin_obj::__register();
