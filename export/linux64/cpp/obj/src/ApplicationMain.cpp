...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("Example, Inc.","\xae","\xa5","\x91","\x5a"),HX_HCSTRING("MyApplication","\x24","\xd3","\xd1","\x1c"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("1.0.0","\xb5","\xd1","\x2e","\x55"));
		HX_STACK_LINE(133)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)0,tmp22,HX_HCSTRING("MyApplication","\x24","\xd3","\xd1","\x1c"),null(),null());
	}
return null();
}
