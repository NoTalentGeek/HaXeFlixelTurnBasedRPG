...
Void ConsoleFrontEnd_obj::registerFunction( ::String FunctionAlias,Dynamic Function){
{
		...
		::String tmp2 = FunctionAlias;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(21)
		Dynamic tmp3 = Function;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(21)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(tmp2,tmp3);
		HX_STACK_LINE(21)
		bool tmp4 = false;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(21)
		if ((tmp4)){
			HX_STACK_LINE(21)
			::String tmp5 = FunctionAlias;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(21)
			_this->__Field(HX_HCSTRING("registeredHelp","\x63","\xe5","\xae","\xb7"), hx::paccDynamic )->__Field(HX_HCSTRING("set","\xa2","\x9b","\x57","\x00"), hx::paccDynamic )(tmp5,null());
		}
	}
return null();
}
