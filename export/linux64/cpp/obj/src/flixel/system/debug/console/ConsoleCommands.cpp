...
HX_STACK_ARG(console,"console")
{
	...
	HX_STACK_LINE(24)
	{
		...
		HX_STACK_LINE(24)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("help","\xc1","\x32","\x0b","\x45"),tmp1);
		HX_STACK_LINE(24)
	...
	HX_STACK_LINE(25)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(25)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("close","\xb8","\x17","\x63","\x48"),tmp1);
		HX_STACK_LINE(25)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(25)
		if ((tmp2)){
	...
	HX_STACK_LINE(27)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(27)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("clearHistory","\x47","\xe7","\xc5","\x3f"),tmp1);
		HX_STACK_LINE(27)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(27)
		if ((tmp2)){
	...
	HX_STACK_LINE(28)
	{
		...
		HX_STACK_LINE(28)
		Dynamic func = tmp->__Field(HX_HCSTRING("clear","\x8d","\x71","\x5b","\x48"), hx::paccDynamic );		HX_STACK_VAR(func,"func");
		HX_STACK_LINE(28)
		{
			HX_STACK_LINE(28)
			Dynamic value = func;		HX_STACK_VAR(value,"value");
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(28)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("clearLog","\xf7","\x50","\x0e","\x31"),tmp1);
		HX_STACK_LINE(28)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(28)
		if ((tmp2)){
	...
	HX_STACK_LINE(30)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(30)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("resetState","\xc2","\xad","\xa7","\x6c"),tmp1);
		HX_STACK_LINE(30)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(30)
		if ((tmp2)){
	...
	HX_STACK_LINE(31)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(31)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("switchState","\x7d","\x07","\x8b","\x77"),tmp1);
		HX_STACK_LINE(31)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(31)
		if ((tmp2)){
	...
	HX_STACK_LINE(32)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(32)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("resetGame","\x61","\xfd","\x4a","\x8a"),tmp1);
		HX_STACK_LINE(32)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(32)
		if ((tmp2)){
	...
	HX_STACK_LINE(34)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(34)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("fields","\x79","\x8e","\x8e","\x80"),tmp1);
		HX_STACK_LINE(34)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(34)
		if ((tmp2)){
	...
	HX_STACK_LINE(36)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(36)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("listObjects","\x16","\xdc","\x4e","\x39"),tmp1);
		HX_STACK_LINE(36)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(36)
		if ((tmp2)){
	...
	HX_STACK_LINE(37)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(37)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("listFunctions","\x1d","\x52","\x37","\xc0"),tmp1);
		HX_STACK_LINE(37)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(37)
		if ((tmp2)){
	...
	HX_STACK_LINE(39)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(39)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("pause","\xf6","\xd6","\x57","\xbd"),tmp1);
		HX_STACK_LINE(39)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(39)
		if ((tmp2)){
	...
	HX_STACK_LINE(41)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(41)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("clearBitmapLog","\x88","\xb0","\xe0","\x84"),tmp1);
		HX_STACK_LINE(41)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(41)
		if ((tmp2)){
	...
	HX_STACK_LINE(42)
	{
		...
		::flixel::_system::frontEnds::BitmapLogFrontEnd tmp = ::flixel::FlxG_obj::bitmapLog;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(42)
		Dynamic func = tmp->__Field(HX_HCSTRING("viewCache","\x9d","\x09","\xa9","\x81"), hx::paccDynamic );		HX_STACK_VAR(func,"func");
		HX_STACK_LINE(42)
		{
			HX_STACK_LINE(42)
			Dynamic value = func;		HX_STACK_VAR(value,"value");
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(42)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("viewCache","\x9d","\x09","\xa9","\x81"),tmp1);
		HX_STACK_LINE(42)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(42)
		if ((tmp2)){
	...
	HX_STACK_LINE(44)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(44)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("create","\xfc","\x66","\x0f","\x7c"),tmp1);
		HX_STACK_LINE(44)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(44)
		if ((tmp2)){
	...
	HX_STACK_LINE(46)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(46)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("watchMouse","\x56","\x31","\x6f","\x84"),tmp1);
		HX_STACK_LINE(46)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(46)
		if ((tmp2)){
	...
	HX_STACK_LINE(47)
	{
		...
		Dynamic tmp1 = func;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(47)
		::flixel::_system::debug::console::ConsoleUtil_obj::registerFunction(HX_HCSTRING("track","\x8b","\x8e","\x1f","\x16"),tmp1);
		HX_STACK_LINE(47)
		bool tmp2 = true;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(47)
		if ((tmp2)){
	...
	HX_STACK_ARG(Params,"Params")
{
		...
		HX_STACK_LINE(145)
		{
			...
			HX_STACK_LINE(145)
			::flixel::FlxObject tmp14 = obj;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(145)
			::flixel::_system::debug::console::ConsoleUtil_obj::registerObject(tmp13,tmp14);
		}
		HX_STACK_LINE(147)
		{
			HX_STACK_LINE(147)
