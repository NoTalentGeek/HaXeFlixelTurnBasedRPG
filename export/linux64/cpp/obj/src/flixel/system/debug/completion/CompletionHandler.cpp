...
Void CompletionHandler_obj::invokeCompletion( ::String path,bool isPeriod){
{
		...
		HX_STACK_LINE(59)
		Array< ::String > items = null();		HX_STACK_VAR(items,"items");
		HX_STACK_LINE(61)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			...
			if ((tmp)){
				...
				HX_STACK_LINE(65)
				Dynamic tmp2 = ::flixel::_system::debug::console::ConsoleUtil_obj::runCommand(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(65)
				Dynamic output = tmp2;		HX_STACK_VAR(output,"output");
				HX_STACK_LINE(66)
				Dynamic tmp3 = output;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(66)
				items = ::flixel::_system::debug::console::ConsoleUtil_obj::getFields(tmp3);
			}
		}
		}
		catch(Dynamic __e){
			{
				...
				Dynamic e = __e;{
					HX_STACK_LINE(71)
					bool tmp = isPeriod;		HX_STACK_VAR(tmp,"tmp");
					HX_STACK_LINE(71)
					if ((tmp)){
						HX_STACK_LINE(73)
						::flixel::_system::debug::completion::CompletionList tmp1 = this->completionList;		HX_STACK_VAR(tmp1,"tmp1");
						HX_STACK_LINE(73)
						tmp1->__Field(HX_HCSTRING("close","\xb8","\x17","\x63","\x48"), hx::paccDynamic )();
						HX_STACK_LINE(74)
						return null();
					}
				}
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(82)
			Float tmp3 = this->getCharXPosition();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(82)
			tmp2->__Field(HX_HCSTRING("show","\xfd","\xd4","\x52","\x4c"), hx::paccDynamic )(tmp3,items);
		}
		else{
			HX_STACK_LINE(84)
			::flixel::_system::debug::completion::CompletionList tmp2 = this->completionList;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(84)
			tmp2->__Field(HX_HCSTRING("close","\xb8","\x17","\x63","\x48"), hx::paccDynamic )();
		}
	}
return null();
}
...
Array< ::String > CompletionHandler_obj::getGlobals( ){
	HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","getGlobals",0x3af6d144,"flixel.system.debug.completion.CompletionHandler.getGlobals","flixel/system/debug/completion/CompletionHandler.hx",91,0x776a5e1a)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static Array< ::String > Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/completion/CompletionHandler.hx",91,0x776a5e1a)
			{
				HX_STACK_LINE(91)
				...
				HX_STACK_LINE(91)
				Dynamic tmp1 = tmp->__Field(HX_HCSTRING("variables","\xb7","\xe2","\x62","\x82"), hx::paccDynamic )->__Field(HX_HCSTRING("keys","\xf4","\xe1","\x06","\x47"), hx::paccDynamic )();		HX_STACK_VAR(tmp1,"tmp1");
				HX_STACK_LINE(91)
				for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(tmp1);  __it->hasNext(); ){
					::String global = __it->next();
					{
						HX_STACK_LINE(91)
						::String tmp2 = global;		HX_STACK_VAR(tmp2,"tmp2");
						HX_STACK_LINE(91)
						_g->push(tmp2);
					}
;
	...
	HX_STACK_LINE(91)
	return ::flixel::util::FlxStringUtil_obj::sortAlphabetically(_Function_1_1::Block());
}
...
{
		HX_STACK_FRAME("flixel.system.debug.completion.CompletionHandler","selectionChanged",0xb4bbcb12,"flixel.system.debug.completion.CompletionHandler.selectionChanged","flixel/system/debug/completion/CompletionHandler.hx",126,0x776a5e1a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(selectedItem,"selectedItem")
		HX_STACK_LINE(126)
		try
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			...
			::String tmp1 = tmp->get_text();		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(128)
			::String tmp2 = this->getLastWord(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(128)
			::String lastWord = tmp2;		HX_STACK_VAR(lastWord,"lastWord");
			HX_STACK_LINE(129)
			::String tmp3 = lastWord;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(129)
			::String tmp4 = selectedItem;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(129)
			::String tmp5 = this->getCompletedText(tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(129)
			::String command = tmp5;		HX_STACK_VAR(command,"command");
			HX_STACK_LINE(130)
			::String tmp6 = command;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(130)
			Dynamic tmp7 = ::flixel::_system::debug::console::ConsoleUtil_obj::runCommand(tmp6);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(130)
			Dynamic output = tmp7;		HX_STACK_VAR(output,"output");
			HX_STACK_LINE(132)
			...
			HX_STACK_LINE(133)
			{
				...
				HX_STACK_LINE(133)
				::flixel::_system::debug::watch::Watch tmp9 = tmp8->debugger->__Field(HX_HCSTRING("watch","\x4f","\x16","\x25","\xc5"), hx::paccDynamic );		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(133)
				Dynamic tmp10 = output;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(133)
				tmp9->__Field(HX_HCSTRING("updateQuickWatch","\x8b","\x93","\x1f","\x3e"), hx::paccDynamic )(HX_HCSTRING("Selection","\x2c","\xd8","\xed","\x2f"),tmp10);
			}
		}
		}
		catch(Dynamic __e){
