...
Void FlxGame_obj::switchState( ){
{
		...
		HX_STACK_LINE(629)
		{
			...
			HX_STACK_LINE(629)
			Dynamic anyObject = tmp12;		HX_STACK_VAR(anyObject,"anyObject");
			HX_STACK_LINE(629)
			{
				HX_STACK_LINE(629)
			...
			HX_STACK_LINE(629)
			Dynamic tmp13 = anyObject;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(629)
			::flixel::_system::debug::console::ConsoleUtil_obj::registerObject(HX_HCSTRING("state","\x11","\x76","\x0b","\x84"),tmp13);
		}
	}
return null();
}
