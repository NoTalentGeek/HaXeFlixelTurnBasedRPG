...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(548)
		::flixel::util::FlxSave tmp17 = ::flixel::FlxG_obj::save;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(548)
		tmp17->bind(HX_HCSTRING("flixel","\x5c","\x42","\x70","\x3d"));
		HX_STACK_LINE(550)
		::flixel::_system::frontEnds::PluginFrontEnd tmp18 = ::flixel::_system::frontEnds::PluginFrontEnd_obj::__new();		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(550)
		::flixel::FlxG_obj::plugins = tmp18;
		HX_STACK_LINE(551)
		::flixel::_system::frontEnds::VCRFrontEnd tmp19 = ::flixel::_system::frontEnds::VCRFrontEnd_obj::__new();		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(551)
		::flixel::FlxG_obj::vcr = tmp19;
		HX_STACK_LINE(554)
		::flixel::_system::frontEnds::SoundFrontEnd tmp20 = ::flixel::_system::frontEnds::SoundFrontEnd_obj::__new();		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(554)
		::flixel::FlxG_obj::sound = tmp20;
	}
return null();
}
