...
::String Fast_obj::get_name( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_name",0x9611daa7,"haxe.xml.Fast.get_name","/usr/share/haxe/std/haxe/xml/Fast.hx",133,0xf81b771c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
::String Fast_obj::get_innerData( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_innerData",0x21ea0104,"haxe.xml.Fast.get_innerData","/usr/share/haxe/std/haxe/xml/Fast.hx",137,0xf81b771c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(138)
...
Dynamic Fast_obj::get_elements( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_elements",0x6707fc93,"haxe.xml.Fast.get_elements","/usr/share/haxe/std/haxe/xml/Fast.hx",164,0xf81b771c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(165)
	::Xml tmp = this->x;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(165)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &it){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/share/haxe/std/haxe/xml/Fast.hx",166,0xf81b771c)
			{
				...
				::haxe::xml::Fast run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","/usr/share/haxe/std/haxe/xml/Fast.hx",168,0xf81b771c)
					{
						HX_STACK_LINE(169)
